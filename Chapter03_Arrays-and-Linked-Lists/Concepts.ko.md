...
> **최종 수정일:** 2026-06-19
>
> Data Structures and Abstractions with Java, Carrano & Henry (4th Ed.) - Ch 3

> **선수 지식**: [프로그래밍언어] Java. [자료구조] 복잡도 분석 (제1-2장).
>
> **학습 목표**:
> 1. 배열 기반 및 연결 리스트 자료 구조를 구현할 수 있다
> 2. 배열 vs 연결 리스트 연산의 시간 복잡도를 비교할 수 있다
> 3. 순차 접근을 위한 이터레이터 패턴을 적용할 수 있다
